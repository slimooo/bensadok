...
En outre, nos contrats contiennent une clause de réversibilité permettant à nos clients de récupérer leurs données sous un format libre et ouvert.

Grâce à l’utilisation de votre nom de domaine, Abla Analytics s'intègre de manière transparente sur vos sites.

<figure class="kg-card kg-image-card"><img src=" __GHOST_URL__ /content/images/2021/05/google-analytics-alternative-rgpd.svg" class="kg-image" alt loading="lazy" width="1324" height="1123"></figure>
## Une mesure d’audience privacy by design

Abla Analytics a été imaginée par nos consultants RGPD. Chaque fonctionnalité a été développée en prenant en compte les principes de protection des données personnelles et de sécurité informatique.

Notre objectif est de proposer [une solution de mesure d’audience dans le respect absolu de la vie privée des utilisateurs](https://abla.io/).

Abla Analytics n’utilise ou ne dépose aucun cookie. Les adresses IP des utilisateurs et le numéro d’identification du terminal utilisé sont instantanément anonymisés. Aucune autre donnée personnelle n’est collectée. Il est tout bonnement impossible de retrouver à l’aide notre outil l’identité d’une personne ayant consulté un site internet.

Pour nos clients cette approche leur permet d’améliorer l’expérience utilisateur en s’affranchissant de l’obligation d’afficher une fenêtre cookie.

En utilisant Abla Analytics plus besoin de recueillir le consentement de l’utilisateur. La mesure d’audience est effective dès la première seconde de la visite.

## Une équipe d’experts analytics à vos côtés

Avant d’être une application, Indatable est avant tout une équipe à l’écoute des besoins de ses clients. Nous vous accompagnons tout au long du processus de migration vers notre solution : import initial de données, intégration de l’application, formation, création de dashboards…

En complément de notre offre principale, nous proposons également des prestations de développements spécifiques pour adapter Abla Analytics aux besoins de nos clients.

Afin de garantir une expérience-client optimale, nous assurons également un support technique.

> [Demander une démonstration](mailto:bonjour@abla.io)

## Foire aux questions

### Abla Analytics est-elle une alternative à Google Analytics ?

Avec Abla Analytics notre objectif est de proposer une solution de mesure d’audience simple, légère et respectueuse de la vie privée des utilisateurs. Vous retrouverez les fonctionnalités essentielles pour identifier les sources de trafic, les pages les plus consultées, les pays d’origine des visiteurs, les caractéristiques de leur terminal…

En revanche, notre modèle économique diffère grandement de celui de Google. Notre solution collecte seulement les données strictement nécessaires sur les visiteurs et ne réalise aucun profilage. Il nous est donc impossible de proposer à nos clients des mesures aussi précises que celles de Google Analytics.

### Comment garantissez-vous la vie privée des visiteurs ?
